...
public class ObjectFactory {
    ...
    private final static QName _MultiplyResponse_QNAME = new QName("http://endpoint/", "multiplyResponse");
    private final static QName _Multiply_QNAME = new QName("http://endpoint/", "multiply");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://endpoint/", name = "multiplyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://endpoint/", name = "multiply")
